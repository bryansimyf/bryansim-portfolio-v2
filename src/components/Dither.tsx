...
function DitheredWaves({
  ...
  const effect = useRef<RetroEffectImpl | null>(null);
  ...
  // Update RetroEffect properties - Ensure effect.current is valid
  useEffect(() => {
    if (effect.current) {
  ...
  // Memoize EffectComposer to prevent unnecessary re-renders
